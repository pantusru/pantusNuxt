        ...
        <div class="container">
            ...
            <b-collapse id="nav-collapse" is-nav>
                <b-navbar-nav class="py-1">
                    ...
                    <b-nav-item to="" class="" link-classes="text-4a4a4a link-d56971 d-lg-none px-10px pb-lg-0 pb-2">О компании </b-nav-item> 
                    <!-- Выплывающий список и прост ссылка -->
                ...
                <b-navbar-nav class="ml-auto px-10px">
                     <b-nav-item link-classes="text-436174 pb-lg-0 pb-2 pt-0" href="tel:88005558721"> <strong>8 (800) 555 87 21</strong></b-nav-item>

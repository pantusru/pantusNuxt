  ...
  head() {
    return {
      ...
      meta: [
        {
          name: "description",
          content: `Производитель запчастей ${this.brand.name} - страна происхождения, преимущества, категории запчастей, условия гарантии. Купить запчасти ${this.brand.name} оптом с доставкой.`,
        },
        {
          name: "keywords",
          content: `${this.brand.name}, запчасти, производитель автозапчастей, оптом, купить`,
        },
      ],
    };
  },

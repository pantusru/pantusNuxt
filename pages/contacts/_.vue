  ...
  head() {
    return {
      ...
      meta: [
        {
          name: "description",
          content: `Интернет-магазин Pantus.ru - Автозапчасти оптом. Контакты ООО "Пантус" ${this.getH1}. Телефоны и Email отделов. График работы. Карта проезда, фактический адреса`,
        },
        {
          name: "keywords",

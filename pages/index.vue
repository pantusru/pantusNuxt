    ...
    return {
      ...
      meta: [
        ...
        },
        {
          name: "description",
          content:
            "Интернет-магазин запчастей Pantus.ru – более 25 000 наименований  автокомпонентов в наличии. Купить запчасти для автомобилей марок:  ВАЗ, RENAULT, ГАЗ, УАЗ, КАМАЗ, МАЗ оптом",
        },
      ],
    };
  },

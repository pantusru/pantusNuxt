  ...
  <section class="mt-5">
    ...
    >
      ...
      <div class="container">
        ...
        <FilterApplicabilities v-if="getFilter" />
        <b-row class="pr-lg-3">
          <b-col cols="12" lg="3" class="mb-lg-0 mb-4">
            <!-- Общие Фильтры -->
            <FilterForm v-if="getFilter" class="block-shadow" />
          </b-col>
          <b-col lg="9" class="block-shadow border block-radius">
            <div
              class="d-flex result-title justify-content-between reset-title mb-1"
            >
...
export default {
  components: {
    ...
    ButtonReplyShow,
    Share,
    FilterForm: () => import("@/components/forms/filter-products"),
    TableProduct,
    productBlog,
    productRow,
    PanelVid,
    FilterApplicabilities: () =>
      import("@/components/forms/filter-applicabilities"),
    MetkaFilter: () => import("@/components/metka/filter/catalog-metka-get"),
    ModalImg,
    ModalBuy,
  },
